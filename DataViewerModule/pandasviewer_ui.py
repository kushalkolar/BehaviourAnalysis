...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.groupBoxPlotting = QtWidgets.QGroupBox(Form)
        ...
        self.gridLayout_8.addWidget(self.comboBoxPlotType, 2, 0, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBoxPlotting.setTitle(_translate("Form", "PlottingControls"))
        self.label_3.setText(_translate("Form", "Plot Type"))
        self.label_2.setText(_translate("Form", "X-Data"))
        self.label.setText(_translate("Form", "Y-Data"))
        self.pushButtonPlot.setText(_translate("Form", "Plot"))
        self.groupBox.setTitle(_translate("Form", "Data Selection"))
        ...
        self.checkBoxUnique.setText(_translate("Form", "Unique vals"))
        self.checkBoxSorting.setText(_translate("Form", "Sort"))
        self.label_4.setText(_translate("Form", "Applied Filters:"))
        self.radioButtonInclude.setText(_translate("Form", "include"))
        self.radioButtonLessThan.setText(_translate("Form", "exclude"))
        self.checkBoxPreviewSelection.setText(_translate("Form", "Preview Selection"))
