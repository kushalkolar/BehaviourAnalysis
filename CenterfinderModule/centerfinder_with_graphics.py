...
# Form implementation generated from reading ui file 'centerfinder_with_graphics.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushButtonOverwrite = QtWidgets.QPushButton(self.groupBoxCenterFinder)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.listWidgetVideos.sizePolicy().hasHeightForWidth())
